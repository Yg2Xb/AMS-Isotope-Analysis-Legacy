{
   delete gROOT->GetStyle("Slide1");
   TStyle *tmpStyle = new TStyle("Slide1", "Style for Presentation");
   tmpStyle->SetNdivisions(508, "x");
   tmpStyle->SetNdivisions(510, "y");
   tmpStyle->SetNdivisions(508, "z");
   ...
   tmpStyle->SetLabelSize(0.07, "x"); /* @@@ */
   tmpStyle->SetLabelSize(0.07, "y"); /* @@@ */
   ...
   //tmpStyle->GetAttDate()->SetTextFont(42);
   ...
   tmpStyle->SetLegendBorderSize(0);
   ...
   tmpStyle->SetTitleFillColor(10); // @@@
   //tmpStyle->SetTitleTextColor(600);
   tmpStyle->SetTitleBorderSize(0);
   tmpStyle->SetTitleFont(42);
   tmpStyle->SetTitleFontSize(0.07); // @@@
   tmpStyle->SetTitleStyle(0);
   tmpStyle->SetTitleX(0.01);
   tmpStyle->SetTitleY(0.999);
   tmpStyle->SetTitleW(0);
   tmpStyle->SetTitleH(0);
   tmpStyle->SetLegendFillColor(10);
