...
// Fri Apr 18 09:51:17 2025 by ROOT version 6.30/00
// from TTree amstreea/amstreea
// found on file: root://eosams.cern.ch//eos/ams/user/z/zuhao/yanzx/ams_data/amsd69n_IHEPQcutDST/1731755257_10.root
//////////////////////////////////////////////////////////
...
#ifdef amstreea_cxx
amstreea::amstreea(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://eosams.cern.ch//eos/ams/user/z/zuhao/yanzx/ams_data/amsd69n_IHEPQcutDST/1731755257_10.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://eosams.cern.ch//eos/ams/user/z/zuhao/yanzx/ams_data/amsd69n_IHEPQcutDST/1731755257_10.root");
      }
...
Int_t amstreea::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t amstreea::LoadTree(Long64_t entry)
{
...
void amstreea::Show(Long64_t entry)
{
...
Int_t amstreea::Cut(Long64_t entry)
{
